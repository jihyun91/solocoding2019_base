...
class MyBackgroundApp extends StatefulWidget {
  @override
  _MyBackgroundAppState createState() => new _MyBackgroundAppState();
}

class _MyBackgroundAppState extends State<MyBackgroundApp> {
  bool _enabled = true;
  int _status = 0;
